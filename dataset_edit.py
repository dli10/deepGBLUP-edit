...
def load_dataset(raw_path, phen_path, h2, device='cpu'):
    ...
    SNPs = next(raw_file).split()[1:] ## edit ##
    ...
    for line in tqdm(raw_file):
        ...
        if line_[0] in train_ids: ## edit ##
            train_X.append(line_[1:]) ## edit ##        
            train_y.append(phen[line_[0]]) ## edit ##
        else:
            test_X.append(line_[1:]) ## edit ##        
            test_ids.append(line_[0]) ## edit ##
